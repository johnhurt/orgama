...
public class AuthBootstrapperPositiveAuthenticationWithFacebookTest {
	...
	public static class Module extends OrgamaTstModule {
		...
		protected String getAuthServiceName() {
			return AuthServiceName.facebook;
		}
	...
	@Inject IFacebookUserService facebook;
	
	public AuthBootstrapperPositiveAuthenticationWithFacebookTest() {
	}
